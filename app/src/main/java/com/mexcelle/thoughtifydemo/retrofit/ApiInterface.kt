package com.mexcelle.thoughtifydemo.retrofit
...
interface ApiInterface {
    ...
    @Headers("Content-Type:application/json")
    @PUT("/api/v1/users/notification_token")
    fun updateFCMTokenToServer(
        @Header("X-API-KEY") Strin: Any,
        @Header("X-AUTH-TOKEN") String: Any,
        @Body updateFCMTokenInputData: UpdateFCMTokenInputData
    )
            : Call<UpdateFCMTokenResponseData>
    ...
    fun updateProfileData(
        @Header("X-API-KEY") Strin: Any,
        @Header("X-AUTH-TOKEN") String: Any,
        @Body updateProfileInputData: UpdateProfileInputData
    )
            : Call<LoginResponseData>
    ...
    fun getEthinicityList(
        @Header("X-API-KEY") String: Any
    )
            : Call<ArrayList<EthinicityResponseData?>?>


    @Headers("Content-Type:application/json")
    @GET("/api/v1/ancestral_heritage")
    fun getAncestralHeritageList(
        @Header("X-API-KEY") String: Any
    )
            : Call<ArrayList<AncestralHeritageResponseData?>?>
    ...
    @Multipart
    @PUT("/api/v1/users/profile_image")
    fun uploadImage(
        @Header("X-API-KEY") Strin: Any,
        @Header("X-AUTH-TOKEN") String: Any,
    ...
    fun changePassword(@Header("X-API-KEY") Strin: Any,
                  @Header("X-AUTH-TOKEN") String: Any,
                  @Body changePasswordInputData: ChangePasswordInputData)
            : Call<ChangePasswordResponseData>
