...
import com.mexcelle.thoughtifydemo.databinding.LoginActivityBinding
...
import com.mexcelle.thoughtifydemo.viewModel.LoginScreenViewModel
...
class LoginActivity : AppCompatActivity() {
            ...
            if (Utility.isOnline(this@LoginActivity)) {
                ...
                loginScreenViewModel.login(this@LoginActivity)!!
                    .observe(this, Observer { loginResponseData ->
                        ...
                        prefs.initUserImageUrl = Constants.USER_IMAGE
                        prefs.initUserId = Constants.USER_ID



                        if(loginResponseData.age != null){
    ...
    private fun Init() {
        ...
        Utility.setRegular(this@LoginActivity, login_txt2)
