...
class TextDrawable(context: Context) : Drawable() { /* Platform XML constants for typeface */
    ...
    init {/*TextDrawable(context: Context)*/
        //this.super()
        ...
        val a: TypedArray = context.getTheme().obtainStyledAttributes(themeAttributes)
